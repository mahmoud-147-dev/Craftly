    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryItems", x => new { x.ProductId, x.InventoryReservationId });
                    table.CheckConstraint("CK_InventoryItem_Quantity", "[Quantity] > 0");
                    table.ForeignKey(
                        name: "FK_InventoryItems_InventoryReservations_InventoryReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_InventoryReservationId",
